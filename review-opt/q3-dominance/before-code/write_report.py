...
'''
    ...
    cover21_update=ROOT/"REPORT_COVER21_UPDATE.md"
    if cover21_update.exists():
        first,rest=report.split("\n",1)
        report=first+"\n\n"+cover21_update.read_text()+"\n\n---\n\n以下保留此前各轮原始结果；当前21站覆盖、确认结果及局限以上方更新为准。\n"+rest
    q12_update=ROOT/"REPORT_Q12_UPDATE.md"
    if q12_update.exists():
        first,rest=report.split("\n",1)
        report=first+"\n\n"+q12_update.read_text()+"\n\n---\n\n以下是此前封存记录；Q1/Q2 正确性与持续优化暂停状态以上方本轮复核为准。\n"+rest
