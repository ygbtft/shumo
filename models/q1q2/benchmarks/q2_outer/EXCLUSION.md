...
`models/q1q2/optional/outer_exclusion.py`、独立复核器 `check_exclusion.py`、
...
models/q1q2/.venv/bin/python -m models.q1q2.benchmarks.q2_outer.exclusion_run solve
...
# 可另选输出目录，不覆盖本次证书：
models/q1q2/.venv/bin/python -m models.q1q2.benchmarks.q2_outer.exclusion_run solve --output /tmp/q2-outer-replay
models/q1q2/.venv/bin/python -m models.q1q2.benchmarks.q2_outer.exclusion_run verify --output /tmp/q2-outer-replay
# 预算退出及其完整域覆盖也必须通过复核：
models/q1q2/.venv/bin/python -m models.q1q2.benchmarks.q2_outer.exclusion_run solve --max-nodes 9 --output /tmp/q2-outer-budget
models/q1q2/.venv/bin/python -m models.q1q2.benchmarks.q2_outer.exclusion_run verify --output /tmp/q2-outer-budget
