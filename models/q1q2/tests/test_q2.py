...
import numpy as np
import pytest
from models.q1q2.geometry import NumericPolicy, BearingMeasurement as Obs
from models.q1q2.feasible import PhysicsConfig, build_source_set, Feedback
from models.q1q2.q2 import (SourceSamples, SearchConfig, score_point, sample_sources,
