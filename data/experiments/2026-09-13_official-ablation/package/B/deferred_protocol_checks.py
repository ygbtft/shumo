"""Deferred/predicted policies over an owned ephemeral loopback HTTP service."""
import gzip
...
def main():
    ...
    paths = all_paths()
    checks = []
    for problem, method in ((3,"deferred_area7"),(4,"cheap_predict8_width015"),(4,"cheap_predict8_arc05_width015"),(4,"batch_history_first8_width015")):
