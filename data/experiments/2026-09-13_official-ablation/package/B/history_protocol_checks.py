"""Historical/faithful policies over an owned ephemeral loopback HTTP service."""
import gzip
...
def main():
    ...
    paths = all_paths()
    checks = []
    for problem, method in ((3,"faithful_area7"),(4,"faithful_width015"),(4,"faithful_arc05_width015"),(4,"history_first8_width015")):
