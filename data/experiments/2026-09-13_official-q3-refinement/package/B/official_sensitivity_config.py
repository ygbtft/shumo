"""Frozen parameter assignments for official practice only; no simulator imports."""
import hashlib
import json
import random
...
DEFAULT = {
    3: dict(trial_radius=50., share_limit=6, max_active=3,
            localization_weight=.08, remainder_weight=1.5),
