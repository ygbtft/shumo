...
& 'C:\Python314-arm64\python.exe' -B run_bounded_robot.py --problem 3 --method range_area7 --mode practice --base-url http://127.0.0.1:2026 --robot-id 202623001141 --confirm-practice
