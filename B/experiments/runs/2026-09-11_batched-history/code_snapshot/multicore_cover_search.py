...
OUT=ROOT / "experiments/runs/2026-09-11_multicore-cover-search"
...
def run():
    ...
    specs=[(a,b,c,d,e) for a in (250.,350.,450.) for b in (1060.,1080.,1100.)
           for c in (1868.,1880.,1900.) for d in (0.,30.) for e in (0.,15.,30.,45.)]
    snapshot=OUT / "code_snapshot"
    snapshot.mkdir()
    hashes={}
    for name in ("multicore_cover_search.py","visibility_certificate.py","coverage.py","geometry.py","icra_final_checks.py"):
