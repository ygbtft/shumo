...
import numpy as np
import pytest
from algorithms.q1q2.geometry import NumericPolicy, Region, RegionKind, convex_hull, diameter
from algorithms.q1q2.circle import (minimum_circle, forced_circle, ordinary_three_point_circle,
    ForcedSupportError, diameter_circle_cover, clearance_diameter_regime)
from algorithms.q1q2.diagnostics import equilateral_case, worst_radius_scale
