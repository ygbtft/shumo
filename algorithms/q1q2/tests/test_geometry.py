...
import numpy as np
import pytest
from algorithms.q1q2.geometry import (BearingMeasurement as Obs, NumericPolicy, HalfPlane as HP,
...
def test_hull_merges_near_duplicates_and_collinear_vertices(scale, shift):
    ...
    from algorithms.q1q2.circle import minimum_circle, diameter_circle_cover
...
def test_similarity(scale,offset,rotation):
    from algorithms.q1q2.diagnostics import equilateral_case
