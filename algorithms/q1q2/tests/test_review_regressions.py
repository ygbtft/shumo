...
import math
import pytest
from algorithms.q1q2 import q2, run
from algorithms.q1q2.adapters import ErrorMode, read_measurements
from algorithms.q1q2.diagnostics import clearance_summary, posterior_area, reassess_old_point
from algorithms.q1q2.feasible import PhysicsConfig, Feedback, build_source_set, check_candidate
